...
@NamedQueries({
    ...
    @NamedQuery(name = "KorpaArtikl.findByIdKorpa", query = "SELECT k FROM KorpaArtikl k WHERE k.korpaArtiklPK.idKorpa = :idKorpa"),
    @NamedQuery(name = "KorpaArtikl.findByIdArtikl", query = "SELECT k FROM KorpaArtikl k WHERE k.korpaArtiklPK.idArtikl = :idArtikl"),
    @NamedQuery(name = "KorpaArtikl.findByKolicina", query = "SELECT k FROM KorpaArtikl k WHERE k.kolicina = :kolicina")})
public class KorpaArtikl implements Serializable {
    ...
    public String toString() {
        return "entities.KorpaArtikl[ korpaArtiklPK=" + korpaArtiklPK + " ]";
    }
